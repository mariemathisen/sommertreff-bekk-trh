      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <p className="mt-8 rounded-xl bg-white/60 backdrop-blur-sm border border-white/40 px-5 py-4 text-sm md:text-base text-[#0b1525]/70 text-center leading-relaxed">
            Her kan dere følge med underveis! Poengene fra Logikkolympics, Sommelierlekene og Mario Kart oppdateres fortløpende. Kongen befaler og MVP før midnatt avsløres til slutt — så ingenting er avgjort ennå!
          </p>
        </div>
