      ...
      <div className="relative mx-auto max-w-2xl">
        ...
        {team?.locked && team.shark_tank_theme && (
          <section className="mb-8 text-center">
            ...
            >
              ...
              <p className="mt-1 text-xl font-black">Vibecode x Shark Tank</p>
            </button>
          </section>
        )}
          ...
          return (
            <section className="mb-8 rounded-2xl p-5 backdrop-blur-sm bg-white/60">
              ...
              <p className="mb-4 text-sm text-[#5f7387]">
                Resten av kvelden er Shark Tank-tid. Dere har <strong className="text-[#0b1525]">{totalMinutes} minutter</strong> totalt.
        ...
        <section className="mb-8 rounded-2xl p-5 backdrop-blur-sm bg-white/60">
          ...
          <p className="mb-4 text-sm text-[#5f7387]">
            ...
            Mario Kart gjøres i Shark Tank-tiden, når begge lag har en friperiode.
